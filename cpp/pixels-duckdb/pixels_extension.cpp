...
//    }
    ...
    void PixelsExtension::Load(ExtensionLoader &loader) {
        ...
        {
            if (ConfigFactory::Instance().boolCheckProperty("pixels.enable.dynamic.buffer"))
            {
        ...
        else if (ConfigFactory::Instance().boolCheckProperty("pixel.enable.globalBytebuffer"))
        {
            try {
