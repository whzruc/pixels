...
int pixels::ThreadContext::GetThreadId() {
    return threadId_;
}

struct io_uring* pixels::ThreadContext::GetRing() {
    return activeRing_;
}

struct io_uring* pixels::ThreadContext::GetCurrentRing() {
    return currentRing_;
}

struct io_uring* pixels::ThreadContext::GetPrefetchRing() {
    return prefetchRing_;
}

void pixels::ThreadContext::UseCurrentRing() {
    activeRing_ = currentRing_;
}

void pixels::ThreadContext::UsePrefetchRing() {
    activeRing_ = prefetchRing_;
}
